...
class TestCaffe2Backend(unittest.TestCase):
    ...
    # test for a pytorch constant folding optimization pass
    def test_lstm_constant_folding(self):
        ...
        self.run_actual_test(model1, train=False, batch_size=batch_size1, input=input1, use_gpu=False, do_constant_folding=False)

        batch_size2 = 3
        model2, input2 = get_LstmNet_model_and_inputs(5, 4, 3, batch_size2, 7, False)
        self.run_actual_test(model2, train=False, batch_size=batch_size2, input=input2, use_gpu=False, do_constant_folding=False)
